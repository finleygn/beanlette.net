...
type AssetLoadableToLoaded<T extends { [k: string]: AssetLoaderFn<unknown> }> = Remap<{
...
export const AssetLoaders = {
  ...
  audio: createAssetLoaderFactory<HTMLAudioElement>((resourcePath) => {
...
function createAssetLoader<const T extends { [k: string]: AssetLoaderFn<unknown> }>(assets: T) {
